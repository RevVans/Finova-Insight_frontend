...
const data = [
  { name: 'Mar', pemasukan: 8500000, pengeluaran: 14500000 },
  { name: 'Apr', pemasukan: 14800000, pengeluaran: 6200000 },
  { name: 'Mei', pemasukan: 9500000, pengeluaran: 4600000 },
];
...
const RevenueBarChart = () => {
    return (
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm h-full w-full">
            <h3 className="text-gray-800 font-medium mb-8 text-lg">Grafik pemasukan vs perbandingan</h3>
